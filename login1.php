                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="w-100 pb-2 pb-4">
                            ...
                            <span class="text-muted color-orange">Faça seu login abaixo para prosseguir</span>
                        </div>
                        <div class="mb-4">
                            <label for="usuario" class="mb-2">Usuário</label>
                            <input type="text" class="form-control rounded-0" id="usuario" name="usuario" required>
                        </div>
                        <div class="mb-4">
